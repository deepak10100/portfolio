...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: <Mail className="w-5 h-5" />, label: 'Email', value: 'deepakmalakar98185@gmail.com', link: 'mailto:deepakmalakar98185@gmail.com' },
    { icon: <Phone className="w-5 h-5" />, label: 'Phone', value: '+918810247229', link: 'tel:+918810247229' },
    { icon: <MapPin className="w-5 h-5" />, label: 'Location', value: 'Ghaziabad, UP, India' },
    { icon: <Clock className="w-5 h-5" />, label: 'Time Zone', value: 'IST (UTC+5:30)' },
  ]

  const socialLinks = [
    { icon: <Github className="w-5 h-5" />, label: 'GitHub', link: 'https://github.com/deepak10100' },
    { icon: <Linkedin className="w-5 h-5" />, label: 'LinkedIn', link: 'https://www.linkedin.com/in/deepak0010/' },
    { icon: <MessageCircle className="w-5 h-5" />, label: 'WhatsApp', link: 'https://wa.me/+918810247229' },
  ]
