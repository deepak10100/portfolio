...
import cvPdf from "@/assets/files/cv_pdf/RESUME.pdf";
...
const Home = () => {
  ...
  const email = "deepakmalakar98185@gmail.com";
  const whatsappNumber = "+918810247229";

  const { data: githubData } = useSWR(
    "https://api.github.com/users/deepak10100",
    fetcher,
    {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 mt-7 sm:mt-0 md:mt-3 lg:mt-5">
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        ...
        >
          Web Developer specializing in Frontent Development with
          expertise in React.js, TailwindCss, NextJS and modern Web Technologies.
        </motion.p>
