      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">Deepak Malakar</span>
            </Link>
            <p className="text-sm text-gray-400">
              Frontend Developer based in Ghaziabad, UP, India.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  aria-label="Email Deepak Malakar"
                >
                  <Mail className="w-4 h-4" aria-hidden="true" />
                  deepakmalakar98185@gmail.com
                </a>
              </li>
              <li>
                <a
                  ...
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Call Deepak Malakar"
                >
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/deepak10100"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/deepak0010/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a
                href="mailto:deepakmalakar98185@gmail.com"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Email"
              >
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Deepak Malakar. All rights reserved.
            </p>
